...
int main()
{
    char *nome, *cognome, *min, *nomecognome[2];
    char *s_merge, s_incastona;
    ...
    scanf("%s", cognome);
    nome = xrealloc(cognome, strlen(cognome)+1);

    nomecognome[0] = nome;
    nomecognome[1] = cognome;

    s_merge = merge(nome, cognome);
    ...
    s_incastona = incastona(nome, cognome);
